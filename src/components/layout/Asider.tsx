...
export default function Asider() {
    return (
        <aside className="my-md:pt-20 pt-5 my-md:w-64 my-sm:w-3/4 w-[95%] my-md:relative">
            <div className="my-md:sticky top-20 left-0  flex my-md:flex-col my-md:gap-5 my-sm:gap-18 gap-5 items-center p-6 bg-my-theme border backdrop-blur-xs border-my-theme-border text-white rounded-lg shadow-lg">
                {/* Profile Image */}
                <img
