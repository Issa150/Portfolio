...
export default function Asider() {
    return (
        <aside className="my-md:pt-20 pt-0 my-md:w-64 my-sm:w-3/4 w-[95%] my-md:relative">
            <div className="my-md:sticky top-20 left-0 flex my-md:flex-col my-md:gap-0 my-sm:gap-18 gap-5 items-center p-6 bg-my-theme border backdrop-blur-xs border-my-theme-border text-white rounded-lg shadow-lg">
                {/* Profile Image */}
                <img
                ...
                <div>
                    ...
                    <div className="sm:grid gap-2.5">
                        {/* Email */}
                        <div className="flex items-center gap-2 mt-2">
                            <EnvelopeIcon className="w-5 h-5 --text-my-theme-icon" />
                            <p className="text-sm"><a href="mailto:issajafari@gmail.com">issajafari@gmail.com</a></p>
                        </div>
                        ...
                        {/* VC */}
                        <div className="mt-2">
                            <a href="/assets/Alternance CV- développeur Full-Stack.pdf" className="flex items-center gap-2 " download>
